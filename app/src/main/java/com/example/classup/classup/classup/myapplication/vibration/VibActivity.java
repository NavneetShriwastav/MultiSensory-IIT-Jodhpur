package com.example.classup.classup.classup.myapplication.vibration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.classup.classup.classup.myapplication.vibration.VibActivity.this, RelaxActivity.class);
