package com.example.classup.classup.classup.myapplication.ambient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.classup.classup.classup.myapplication.ambient.AmbientActivity.this, RelaxActivity.class);
