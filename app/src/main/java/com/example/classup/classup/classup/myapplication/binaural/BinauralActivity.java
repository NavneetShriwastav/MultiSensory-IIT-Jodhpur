package com.example.classup.classup.classup.myapplication.binaural;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.classup.classup.classup.myapplication.binaural.BinauralActivity.this, RelaxActivity.class);
